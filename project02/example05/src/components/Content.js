    ...
    <div className="container">
      ...
      <div className="texts-group">
        <div className="texts">
          ...
          <p>max <span className="temp"></span>: {data?.main.temp_max}</p>
          <p>min <span className="temp"></span>: {data?.main.temp_min}</p>
        </div>
        <div className="texts">
           <p>풍향 <span className="wind"></span>: {data?.wind.deg} 도</p>
           <p>속도 <span className="wind"></span>: {data?.wind.speed} m/s</p>
        </div>
      </div>
    </div>
  )
